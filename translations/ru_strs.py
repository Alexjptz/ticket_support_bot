...
'____________________________________\n\n'))
    ...
    # Middleware
    middle_check_channel = f'Вы не можете воспользоваться данной командой, так как <b>не подписаны</b> на канал!\n\nВы можете воспользоваться кнопкой и проверить подписку, чтобы быть уверенным, что предоставленный функционал будет вновь работать'
    ...
    # Users General
    general_start = '<b>Добро пожаловать! 👋</b>\n\nЧат-бот поможет Вас оставаться на связи с нашими менеджерами благодаря системе бесед 📋\n\nЧтобы продолжить воспользуйтесь командой /help или соответствующими кнопками меню'
    ...
    ticket_ask_name_error = '<b>Некорректный ввод!</b>\n\nУбедитесь, правильно ли вы ввели данные? Попробуйте отправить свое имя еще раз'

    ticket_ask_title = 'Пожалуйста, введите <b>название</b> темы беседы! <i>(до 50 символов)</i>\n\n<i>Например:</i> брак, доставка, цена и т.д.'
    ticket_ask_title_error = '<b>Некорректный ввод!</b>\n\nУбедитесь, правильно ли вы ввели данные? Попробуйте отправить название беседы еще раз'

    ticket_ask_description = 'Пожалуйста, напишите небольшое <b>описание</b> для большей ясности! <i>(до 100 символов)</i>\n\n<i>Например:</i> не подошел товар, хочу вернуть деньги'
    ticket_ask_description_error = '<b>Некорректный ввод!</b>\n\nУбедитесь, правильно ли вы ввели данные? Попробуйте отправить короткое описание беседы еще раз'
    ...
    restriction_before = lambda date: f'Менеджер запретил Вам создавать или писать в беседы до {date} по МСК. Если у Вас была открытая беседа, то она закрылась!'
    ...
    faq_ask_question_error = '<b>Некорректный ввод!</b>\n\nУбедитесь, правильно ли вы ввели данные? Попробуйте отправить вопрос еще раз'

    faq_ask_content = '<b>Отправьте сообщение</b>, которое будет отображаться при выборе данного вопроса'
